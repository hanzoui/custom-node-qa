...
fn show_dashboard(project: &str) -> Result<()> {
    println!("\n{}", style("ComfyUI Node Testing").bold().cyan());
    ...
    println!(
        "  {} {}",
        style("→").dim(),
        style("github.com/Comfy-Org/comfyui-custom-node-qa").dim()
    );
...
fn show_browser_script(project: &str) -> Result<()> {
    ...
    if choice == 1 {
        ...
        println!("  2. Open ComfyUI in browser");
...
fn show_help_overview() -> Result<()> {
    ...
    println!("  3. Test node packs in ComfyUI browser");
...
fn show_help_workflow() -> Result<()> {
    ...
    println!();
    println!("{}", style("Step 2: Open ComfyUI in browser").bold());
    println!("  • Open your ComfyUI instance");
...
fn show_help_scenarios() -> Result<()> {
    ...
    println!("  2. cd comfyui-custom-node-qa");
...
fn show_help_troubleshooting() -> Result<()> {
    ...
    println!("  • Make sure ComfyUI is fully loaded");
