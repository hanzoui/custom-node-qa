...
This tool helps QA teams track which Hanzo Studio custom node packs have been tested. Multiple testers work together in a **shared GitHub repository**, each testing different packs and sharing their results.
...
- Contain actual node definitions from live Hanzo Studio
...
```
Open Hanzo Studio in your browser
↓
...
- **Workflow JSON files** = what actually exists in Hanzo Studio right now
