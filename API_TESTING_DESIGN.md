...
Some ComfyUI nodes need to be tested via the API rather than the browser UI. This requires a different testing workflow.

## API Testing vs UI Testing

### UI Testing (Current):

- Load ComfyUI in browser
...
3. ComfyUI server URL (default: http://localhost:8188)
...
4. User runs: python main.py (start ComfyUI)
